...
export default function MyScriptsPage() {
  ...
  useEffect(() => {
    fetchUserScripts(userScriptsPage, userScriptsLimit)
  }, [fetchUserScripts, userScriptsPage, userScriptsLimit])

  const handlePageChange = (_: React.ChangeEvent<unknown>, value: number) => {
    fetchUserScripts(value, userScriptsLimit)
  }
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      {userScriptsLoading && userScripts.length === 0 ? (
      ...
      {userScriptsTotalPages > 1 && (
        <Box sx={{ display: 'flex', justifyContent: 'center', mt: 4 }}>
          <Pagination
            count={userScriptsTotalPages}
            page={userScriptsPage}
